...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ILSUser.is_investigator'
        db.add_column('auth_user', 'is_investigator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ILSUser.is_investigator'
        db.delete_column('auth_user', 'is_investigator')

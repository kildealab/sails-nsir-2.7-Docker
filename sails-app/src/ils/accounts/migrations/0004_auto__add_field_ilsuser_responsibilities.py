...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ILSUser.responsibilities'
        db.add_column('auth_user', 'responsibilities',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ILSUser.responsibilities'
        db.delete_column('auth_user', 'responsibilities')

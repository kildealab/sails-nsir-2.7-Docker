...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ILSUser.must_change_password'
        db.add_column('auth_user', 'must_change_password',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ILSUser.must_change_password'
        db.delete_column('auth_user', 'must_change_password')

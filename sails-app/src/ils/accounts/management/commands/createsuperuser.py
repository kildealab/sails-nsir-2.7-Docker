"""
THIS COMMAND OVERRIDES THE DEFAULT createsuperuser COMMAND LOCATED IN THE
VIRTUAL ENVIRONMENT @ django.contrib.auth.management

Customization:
Set the must_change_password field to False for superusers created this way
...
class Command(makesuperuser.Command):
    ...
    def handle(self, *args, **options):
        ...
        try:
            user_data['role'] = Role.objects.get(pk=5)
        except Role.DoesNotExist:
            print "Role not assigned to super user"

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscription.incident'
        db.alter_column(u'notifications_nsir_subscription', 'incident_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['incidents_nsir.Incident']))

    def backwards(self, orm):

        # Changing field 'Subscription.incident'
        db.alter_column(u'notifications_nsir_subscription', 'incident_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['incidents_nsir.Incident']))
    ...
    models = {
        ...
        u'notifications_nsir.subscription': {
            'Meta': {'object_name': 'Subscription'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incident': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'subscriptions'", 'null': 'True', 'to': u"orm['incidents_nsir.Incident']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.ILSUser']"})
        }
    }

    complete_apps = ['notifications_nsir']
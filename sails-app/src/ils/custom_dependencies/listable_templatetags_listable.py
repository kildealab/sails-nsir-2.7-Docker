...
def listable(view_name, save_state=False, css_table_class="", css_input_class=""):
    ...
    #----------------------------------------------------------------------------------
    # Added code to account for namespaced URLS and corresponding views
    if ":" in view_name:
        param, truncated_view_name = view_name.split(":",1)
    else:
        truncated_view_name = view_name
    #----------------------------------------------------------------------------------

    opts = {
        "tableId":"#listable-table-"+truncated_view_name,

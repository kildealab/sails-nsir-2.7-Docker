...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.time_detected'
        db.add_column(u'incidents_nsir_incident', 'time_detected',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.time_occurred'
        db.add_column(u'incidents_nsir_incident', 'time_occurred',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.time_detected'
        db.delete_column(u'incidents_nsir_incident', 'time_detected')

        # Deleting field 'Incident.time_occurred'
        db.delete_column(u'incidents_nsir_incident', 'time_occurred')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocalSeverityLevel'
        db.create_table(u'incidents_nsir_localseveritylevel', (
        ...
        db.send_create_signal(u'incidents_nsir', ['LocalSeverityLevel'])

        # Adding field 'Incident.local_severity_level'
        db.add_column(u'incidents_nsir_incident', 'local_severity_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.LocalSeverityLevel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LocalSeverityLevel'
        db.delete_table(u'incidents_nsir_localseveritylevel')

        # Deleting field 'Incident.local_severity_level'
        db.delete_column(u'incidents_nsir_incident', 'local_severity_level_id')

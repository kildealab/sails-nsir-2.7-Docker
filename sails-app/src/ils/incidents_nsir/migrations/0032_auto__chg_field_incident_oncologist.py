...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incident.oncologist'
        db.alter_column(u'incidents_nsir_incident', 'oncologist_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.ILSUser']))

    def backwards(self, orm):

        # Changing field 'Incident.oncologist'
        db.alter_column(u'incidents_nsir_incident', 'oncologist_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.Oncologist'], null=True))

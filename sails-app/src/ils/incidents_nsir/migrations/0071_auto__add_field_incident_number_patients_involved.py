...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.number_patients_involved'
        db.add_column(u'incidents_nsir_incident', 'number_patients_involved',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.number_patients_involved'
        db.delete_column(u'incidents_nsir_incident', 'number_patients_involved')

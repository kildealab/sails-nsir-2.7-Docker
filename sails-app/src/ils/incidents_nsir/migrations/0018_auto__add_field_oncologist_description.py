...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oncologist.description'
        db.add_column(u'incidents_nsir_oncologist', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oncologist.description'
        db.delete_column(u'incidents_nsir_oncologist', 'description')

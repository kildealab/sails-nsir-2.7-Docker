...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PredefinedIncident.created_by'
        db.alter_column(u'incidents_nsir_predefinedincident', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['accounts.ILSUser']))

    def backwards(self, orm):

        # Changing field 'PredefinedIncident.created_by'
        db.alter_column(u'incidents_nsir_predefinedincident', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.ILSUser']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.investigator'
        db.add_column(u'incidents_nsir_incident', 'investigator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='incident_assigned_to_investigator', null=True, to=orm['accounts.ILSUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.investigator'
        db.delete_column(u'incidents_nsir_incident', 'investigator_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatPlotType'
        db.create_table(u'incidents_nsir_statplottype', (
        ...
        db.send_create_signal(u'incidents_nsir', ['StatPlotType'])


    def backwards(self, orm):
        # Deleting model 'StatPlotType'
        db.delete_table(u'incidents_nsir_statplottype')

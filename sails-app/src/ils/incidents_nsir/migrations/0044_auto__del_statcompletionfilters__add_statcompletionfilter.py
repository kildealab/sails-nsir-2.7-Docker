...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'StatCompletionFilters'
        db.delete_table(u'incidents_nsir_statcompletionfilters')

        # Adding model 'StatCompletionFilter'
        db.create_table(u'incidents_nsir_statcompletionfilter', (
        ...
        db.send_create_signal(u'incidents_nsir', ['StatCompletionFilter'])


    def backwards(self, orm):
        # Adding model 'StatCompletionFilters'
        db.create_table(u'incidents_nsir_statcompletionfilters', (
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'incidents_nsir', ['StatCompletionFilters'])

        # Deleting model 'StatCompletionFilter'
        db.delete_table(u'incidents_nsir_statcompletionfilter')

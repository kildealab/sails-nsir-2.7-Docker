...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.coordinator_comments'
        db.add_column(u'incidents_nsir_incident', 'coordinator_comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.coordinator_comments'
        db.delete_column(u'incidents_nsir_incident', 'coordinator_comments')

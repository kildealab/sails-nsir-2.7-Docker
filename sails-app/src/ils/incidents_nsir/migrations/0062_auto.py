...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field event_type on 'AllowedTemplateField'
        m2m_table_name = db.shorten_name(u'incidents_nsir_allowedtemplatefield_event_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('allowedtemplatefield', models.ForeignKey(orm[u'incidents_nsir.allowedtemplatefield'], null=False)),
            ('eventtype', models.ForeignKey(orm[u'incidents_nsir.eventtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['allowedtemplatefield_id', 'eventtype_id'])


    def backwards(self, orm):
        # Removing M2M table for field event_type on 'AllowedTemplateField'
        db.delete_table(db.shorten_name(u'incidents_nsir_allowedtemplatefield_event_type'))

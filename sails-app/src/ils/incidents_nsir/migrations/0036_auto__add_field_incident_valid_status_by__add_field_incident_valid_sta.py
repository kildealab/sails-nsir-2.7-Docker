...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.valid_status_by'
        db.add_column(u'incidents_nsir_incident', 'valid_status_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='incident_valid_status_by', null=True, to=orm['accounts.ILSUser']),
                      keep_default=False)

        # Adding field 'Incident.valid_status_date'
        db.add_column(u'incidents_nsir_incident', 'valid_status_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.valid_status_by'
        db.delete_column(u'incidents_nsir_incident', 'valid_status_by_id')

        # Deleting field 'Incident.valid_status_date'
        db.delete_column(u'incidents_nsir_incident', 'valid_status_date')

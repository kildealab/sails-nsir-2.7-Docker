...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AllowedTemplateFields'
        db.delete_table(u'incidents_nsir_allowedtemplatefields')

        # Adding model 'AllowedTemplateField'
        db.create_table(u'incidents_nsir_allowedtemplatefield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'incidents_nsir', ['AllowedTemplateField'])


    def backwards(self, orm):
        # Adding model 'AllowedTemplateFields'
        db.create_table(u'incidents_nsir_allowedtemplatefields', (
            ('field_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'incidents_nsir', ['AllowedTemplateFields'])

        # Deleting model 'AllowedTemplateField'
        db.delete_table(u'incidents_nsir_allowedtemplatefield')
    ...
    models = {
        ...
        u'incidents_nsir.allowedtemplatefield': {
            'Meta': {'object_name': 'AllowedTemplateField'},
        ...
        u'incidents_nsir.predefinedfield': {
            ...
            'model_field': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },

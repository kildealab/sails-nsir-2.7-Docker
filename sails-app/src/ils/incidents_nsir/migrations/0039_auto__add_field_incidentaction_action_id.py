...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IncidentAction.action_id'
        db.add_column(u'incidents_nsir_incidentaction', 'action_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IncidentAction.action_id'
        db.delete_column(u'incidents_nsir_incidentaction', 'action_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatDateBin'
        db.create_table(u'incidents_nsir_statdatebin', (
            ...
            ('bin_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'incidents_nsir', ['StatDateBin'])


    def backwards(self, orm):
        # Deleting model 'StatDateBin'
        db.delete_table(u'incidents_nsir_statdatebin')

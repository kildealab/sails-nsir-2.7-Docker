...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatCompletionFilter.filter_name'
        db.add_column(u'incidents_nsir_statcompletionfilter', 'filter_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatCompletionFilter.filter_name'
        db.delete_column(u'incidents_nsir_statcompletionfilter', 'filter_name')

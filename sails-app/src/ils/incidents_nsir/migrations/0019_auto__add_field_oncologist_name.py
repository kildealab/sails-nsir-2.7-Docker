...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oncologist.name'
        db.add_column(u'incidents_nsir_oncologist', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oncologist.name'
        db.delete_column(u'incidents_nsir_oncologist', 'name')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredefinedIncident.created_by'
        db.add_column(u'incidents_nsir_predefinedincident', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='predefined_created_by', null=True, to=orm['accounts.ILSUser']),
                      keep_default=False)

        # Adding unique constraint on 'PredefinedIncident', fields ['name']
        db.create_unique(u'incidents_nsir_predefinedincident', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'PredefinedIncident', fields ['name']
        db.delete_unique(u'incidents_nsir_predefinedincident', ['name'])

        # Deleting field 'PredefinedIncident.created_by'
        db.delete_column(u'incidents_nsir_predefinedincident', 'created_by_id')
    ...
    models = {
        ...
        u'incidents_nsir.incident': {
            ...
            'predefined_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['incidents_nsir.PredefinedIncident']", 'null': 'True', 'blank': 'True'}),
        ...
        u'incidents_nsir.predefinedincident': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'predefined_created_by'", 'null': 'True', 'to': u"orm['accounts.ILSUser']"}),

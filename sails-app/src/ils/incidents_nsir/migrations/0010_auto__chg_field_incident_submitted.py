...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incident.submitted'
        db.alter_column(u'incidents_nsir_incident', 'submitted', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Incident.submitted'
        db.alter_column(u'incidents_nsir_incident', 'submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

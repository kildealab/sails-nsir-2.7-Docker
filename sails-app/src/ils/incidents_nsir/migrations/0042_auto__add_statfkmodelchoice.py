...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatFKModelChoice'
        db.create_table(u'incidents_nsir_statfkmodelchoice', (
            ...
            ('model_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'incidents_nsir', ['StatFKModelChoice'])


    def backwards(self, orm):
        # Deleting model 'StatFKModelChoice'
        db.delete_table(u'incidents_nsir_statfkmodelchoice')

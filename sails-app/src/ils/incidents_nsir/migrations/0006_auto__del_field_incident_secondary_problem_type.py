...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Incident.secondary_problem_type'
        db.delete_column(u'incidents_nsir_incident', 'secondary_problem_type_id')

        # Adding M2M table for field secondary_problem_type on 'Incident'
        m2m_table_name = db.shorten_name(u'incidents_nsir_incident_secondary_problem_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('incident', models.ForeignKey(orm[u'incidents_nsir.incident'], null=False)),
            ('secondaryproblemtype', models.ForeignKey(orm[u'incidents_nsir.secondaryproblemtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['incident_id', 'secondaryproblemtype_id'])


    def backwards(self, orm):
        # Adding field 'Incident.secondary_problem_type'
        db.add_column(u'incidents_nsir_incident', 'secondary_problem_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.SecondaryProblemType'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field secondary_problem_type on 'Incident'
        db.delete_table(db.shorten_name(u'incidents_nsir_incident_secondary_problem_type'))

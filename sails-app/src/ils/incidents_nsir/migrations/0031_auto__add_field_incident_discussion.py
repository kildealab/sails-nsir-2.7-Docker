...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.discussion'
        db.add_column(u'incidents_nsir_incident', 'discussion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.discussion'
        db.delete_column(u'incidents_nsir_incident', 'discussion')

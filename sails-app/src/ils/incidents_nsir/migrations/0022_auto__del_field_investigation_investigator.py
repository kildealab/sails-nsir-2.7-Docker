...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Investigation.investigator'
        db.delete_column(u'incidents_nsir_investigation', 'investigator_id')


    def backwards(self, orm):
        # Adding field 'Investigation.investigator'
        db.add_column(u'incidents_nsir_investigation', 'investigator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='investigations', null=True, to=orm['accounts.ILSUser'], blank=True),
                      keep_default=False)

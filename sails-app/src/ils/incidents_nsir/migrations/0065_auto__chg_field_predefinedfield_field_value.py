...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PredefinedField.field_value'
        db.alter_column(u'incidents_nsir_predefinedfield', 'field_value', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'PredefinedField.field_value'
        db.alter_column(u'incidents_nsir_predefinedfield', 'field_value', self.gf('django.db.models.fields.CharField')(max_length=255))

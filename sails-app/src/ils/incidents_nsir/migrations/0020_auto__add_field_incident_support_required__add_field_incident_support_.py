...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.support_required'
        db.add_column(u'incidents_nsir_incident', 'support_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Incident.support_given'
        db.add_column(u'incidents_nsir_incident', 'support_given',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Incident.support_description'
        db.add_column(u'incidents_nsir_incident', 'support_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.support_required'
        db.delete_column(u'incidents_nsir_incident', 'support_required')

        # Deleting field 'Incident.support_given'
        db.delete_column(u'incidents_nsir_incident', 'support_given')

        # Deleting field 'Incident.support_description'
        db.delete_column(u'incidents_nsir_incident', 'support_description')
    ...
    models = {
        ...
        u'incidents_nsir.incident': {
            ...
            'support_given': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'support_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),

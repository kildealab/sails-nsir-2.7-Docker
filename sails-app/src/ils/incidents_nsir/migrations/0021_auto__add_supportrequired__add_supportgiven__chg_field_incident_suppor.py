...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SupportRequired'
        db.create_table(u'incidents_nsir_supportrequired', (
        ...
        db.send_create_signal(u'incidents_nsir', ['SupportRequired'])

        # Adding model 'SupportGiven'
        db.create_table(u'incidents_nsir_supportgiven', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'incidents_nsir', ['SupportGiven'])


        # Renaming column for 'Incident.support_required' to match new field type.
        db.rename_column(u'incidents_nsir_incident', 'support_required', 'support_required_id')
        # Changing field 'Incident.support_required'
        db.alter_column(u'incidents_nsir_incident', 'support_required_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.SupportRequired'], null=True))
        # Adding index on 'Incident', fields ['support_required']
        db.create_index(u'incidents_nsir_incident', ['support_required_id'])


        # Renaming column for 'Incident.support_given' to match new field type.
        db.rename_column(u'incidents_nsir_incident', 'support_given', 'support_given_id')
        # Changing field 'Incident.support_given'
        db.alter_column(u'incidents_nsir_incident', 'support_given_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.SupportGiven'], null=True))
        # Adding index on 'Incident', fields ['support_given']
        db.create_index(u'incidents_nsir_incident', ['support_given_id'])


    def backwards(self, orm):
        # Removing index on 'Incident', fields ['support_given']
        db.delete_index(u'incidents_nsir_incident', ['support_given_id'])

        # Removing index on 'Incident', fields ['support_required']
        db.delete_index(u'incidents_nsir_incident', ['support_required_id'])

        # Deleting model 'SupportRequired'
        db.delete_table(u'incidents_nsir_supportrequired')

        # Deleting model 'SupportGiven'
        db.delete_table(u'incidents_nsir_supportgiven')


        # Renaming column for 'Incident.support_required' to match new field type.
        db.rename_column(u'incidents_nsir_incident', 'support_required_id', 'support_required')
        # Changing field 'Incident.support_required'
        db.alter_column(u'incidents_nsir_incident', 'support_required', self.gf('django.db.models.fields.BooleanField')())

        # Renaming column for 'Incident.support_given' to match new field type.
        db.rename_column(u'incidents_nsir_incident', 'support_given_id', 'support_given')
        # Changing field 'Incident.support_given'
        db.alter_column(u'incidents_nsir_incident', 'support_given', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'incidents_nsir.actionescalation': {
            'Meta': {'ordering': "['order', 'name']", 'object_name': 'ActionEscalation'},
        ...
        u'incidents_nsir.actionpriority': {
            'Meta': {'ordering': "['order', 'name']", 'object_name': 'ActionPriority'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        u'incidents_nsir.actiontype': {
            'Meta': {'ordering': "['order', 'name']", 'object_name': 'ActionType'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        u'incidents_nsir.incident': {
            ...
            'oncologist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['incidents_nsir.Oncologist']", 'null': 'True', 'blank': 'True'}),
            ...
            'support_given': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['incidents_nsir.SupportGiven']", 'null': 'True', 'blank': 'True'}),
            'support_required': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['incidents_nsir.SupportRequired']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.patient_support_required'
        db.add_column(u'incidents_nsir_incident', 'patient_support_required',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='patient_support_required', null=True, to=orm['incidents_nsir.SupportRequired']),
                      keep_default=False)

        # Adding field 'Incident.patient_support_given'
        db.add_column(u'incidents_nsir_incident', 'patient_support_given',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='patient_support_given', null=True, to=orm['incidents_nsir.SupportGiven']),
                      keep_default=False)

        # Adding field 'Incident.patient_support_description'
        db.add_column(u'incidents_nsir_incident', 'patient_support_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.patient_support_required'
        db.delete_column(u'incidents_nsir_incident', 'patient_support_required_id')

        # Deleting field 'Incident.patient_support_given'
        db.delete_column(u'incidents_nsir_incident', 'patient_support_given_id')

        # Deleting field 'Incident.patient_support_description'
        db.delete_column(u'incidents_nsir_incident', 'patient_support_description')

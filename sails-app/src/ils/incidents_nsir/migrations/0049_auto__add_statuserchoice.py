...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatUserChoice'
        db.create_table(u'incidents_nsir_statuserchoice', (
        ...
        db.send_create_signal(u'incidents_nsir', ['StatUserChoice'])


    def backwards(self, orm):
        # Deleting model 'StatUserChoice'
        db.delete_table(u'incidents_nsir_statuserchoice')

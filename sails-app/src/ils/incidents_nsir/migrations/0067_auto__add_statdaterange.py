...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatDateRange'
        db.create_table(u'incidents_nsir_statdaterange', (
            ...
            ('range_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'incidents_nsir', ['StatDateRange'])


    def backwards(self, orm):
        # Deleting model 'StatDateRange'
        db.delete_table(u'incidents_nsir_statdaterange')
    ...
    models = {
        ...
        u'incidents_nsir.statdaterange': {
            'Meta': {'ordering': "['order', 'name']", 'object_name': 'StatDateRange'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'range_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },

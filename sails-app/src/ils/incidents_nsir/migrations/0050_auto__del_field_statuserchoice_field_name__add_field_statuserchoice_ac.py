...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StatUserChoice.field_name'
        db.delete_column(u'incidents_nsir_statuserchoice', 'field_name')

        # Adding field 'StatUserChoice.account_field_name'
        db.add_column(u'incidents_nsir_statuserchoice', 'account_field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StatUserChoice.incident_field_name'
        db.add_column(u'incidents_nsir_statuserchoice', 'incident_field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StatUserChoice.field_name'
        db.add_column(u'incidents_nsir_statuserchoice', 'field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'StatUserChoice.account_field_name'
        db.delete_column(u'incidents_nsir_statuserchoice', 'account_field_name')

        # Deleting field 'StatUserChoice.incident_field_name'
        db.delete_column(u'incidents_nsir_statuserchoice', 'incident_field_name')

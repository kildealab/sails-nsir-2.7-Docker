...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.predefined_type'
        db.add_column(u'incidents_nsir_incident', 'predefined_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.PredefinedIncident'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.predefined_type'
        db.delete_column(u'incidents_nsir_incident', 'predefined_type_id')

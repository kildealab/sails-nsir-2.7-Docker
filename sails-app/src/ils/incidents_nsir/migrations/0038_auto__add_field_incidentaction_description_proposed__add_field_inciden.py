...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IncidentAction.description_proposed'
        db.add_column(u'incidents_nsir_incidentaction', 'description_proposed',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'IncidentAction.responsible'
        db.add_column(u'incidents_nsir_incidentaction', 'responsible',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_responsible_action', null=True, to=orm['accounts.ILSUser']),
                      keep_default=False)

        # Adding field 'IncidentAction.assigned_by'
        db.add_column(u'incidents_nsir_incidentaction', 'assigned_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_assigned_action', null=True, to=orm['accounts.ILSUser']),
                      keep_default=False)

        # Adding field 'IncidentAction.date_assigned'
        db.add_column(u'incidents_nsir_incidentaction', 'date_assigned',
        ...
        # Adding field 'IncidentAction.description_performed'
        db.add_column(u'incidents_nsir_incidentaction', 'description_performed',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'IncidentAction.completed_by'
        db.add_column(u'incidents_nsir_incidentaction', 'completed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_completed_action', null=True, to=orm['accounts.ILSUser']),
                      keep_default=False)

        # Adding field 'IncidentAction.date_completed'
        db.add_column(u'incidents_nsir_incidentaction', 'date_completed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IncidentAction.description_proposed'
        db.delete_column(u'incidents_nsir_incidentaction', 'description_proposed')
        ...
        # Deleting field 'IncidentAction.date_assigned'
        db.delete_column(u'incidents_nsir_incidentaction', 'date_assigned')

        # Deleting field 'IncidentAction.complete'
        db.delete_column(u'incidents_nsir_incidentaction', 'complete')

        # Deleting field 'IncidentAction.description_performed'
        db.delete_column(u'incidents_nsir_incidentaction', 'description_performed')

        # Deleting field 'IncidentAction.completed_by'
        db.delete_column(u'incidents_nsir_incidentaction', 'completed_by_id')

        # Deleting field 'IncidentAction.date_completed'
        db.delete_column(u'incidents_nsir_incidentaction', 'date_completed')

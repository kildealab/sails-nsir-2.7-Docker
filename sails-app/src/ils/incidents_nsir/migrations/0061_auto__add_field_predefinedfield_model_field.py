...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredefinedField.model_field'
        db.add_column(u'incidents_nsir_predefinedfield', 'model_field',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['incidents_nsir.AllowedTemplateField']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredefinedField.model_field'
        db.delete_column(u'incidents_nsir_predefinedfield', 'model_field_id')

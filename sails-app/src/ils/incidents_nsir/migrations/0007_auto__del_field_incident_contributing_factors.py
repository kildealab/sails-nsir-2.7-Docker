...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Incident.contributing_factors'
        db.delete_column(u'incidents_nsir_incident', 'contributing_factors_id')

        # Adding M2M table for field contributing_factors on 'Incident'
        m2m_table_name = db.shorten_name(u'incidents_nsir_incident_contributing_factors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('incident', models.ForeignKey(orm[u'incidents_nsir.incident'], null=False)),
            ('contributingfactor', models.ForeignKey(orm[u'incidents_nsir.contributingfactor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['incident_id', 'contributingfactor_id'])


    def backwards(self, orm):
        # Adding field 'Incident.contributing_factors'
        db.add_column(u'incidents_nsir_incident', 'contributing_factors',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ContributingFactor'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field contributing_factors on 'Incident'
        db.delete_table(db.shorten_name(u'incidents_nsir_incident_contributing_factors'))

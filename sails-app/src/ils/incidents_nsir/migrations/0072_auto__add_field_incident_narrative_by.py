...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.narrative_by'
        db.add_column(u'incidents_nsir_incident', 'narrative_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='narrative_by', null=True, to=orm['accounts.ILSUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.narrative_by'
        db.delete_column(u'incidents_nsir_incident', 'narrative_by_id')

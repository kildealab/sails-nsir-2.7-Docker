...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oncologist.email'
        db.add_column(u'incidents_nsir_oncologist', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oncologist.email'
        db.delete_column(u'incidents_nsir_oncologist', 'email')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Incident.incident_number'
        db.delete_column(u'incidents_nsir_incident', 'incident_number')

        # Adding field 'Incident.incident_id'
        db.add_column(u'incidents_nsir_incident', 'incident_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Incident.incident_number'
        db.add_column(u'incidents_nsir_incident', 'incident_number',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Incident.incident_id'
        db.delete_column(u'incidents_nsir_incident', 'incident_id')

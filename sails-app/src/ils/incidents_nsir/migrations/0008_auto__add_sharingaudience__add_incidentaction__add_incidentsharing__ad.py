...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SharingAudience'
        db.create_table(u'incidents_nsir_sharingaudience', (
        ...
        db.send_create_signal(u'incidents_nsir', ['SharingAudience'])

        # Adding model 'IncidentAction'
        db.create_table(u'incidents_nsir_incidentaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('incident', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.Incident'])),
            ('action_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ActionType'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('responsible', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incidentactions', to=orm['accounts.ILSUser'])),
            ('priority', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ActionPriority'], null=True, blank=True)),
            ('escalation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ActionEscalation'], null=True, blank=True)),
            ('assigned', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('assigned_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incidentactions_assigned', to=orm['accounts.ILSUser'])),
            ('complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('completed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'incidents_nsir', ['IncidentAction'])

        # Adding model 'IncidentSharing'
        db.create_table(u'incidents_nsir_incidentsharing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('incident', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.Incident'])),
            ('sharing_audience', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.SharingAudience'])),
            ('responsible', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incidentsharing', null=True, to=orm['accounts.ILSUser'])),
            ('assigned', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('assigned_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incidentsharing_assigned', to=orm['accounts.ILSUser'])),
        ...
        db.send_create_signal(u'incidents_nsir', ['IncidentSharing'])

        # Adding model 'ActionPriority'
        db.create_table(u'incidents_nsir_actionpriority', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'incidents_nsir', ['ActionPriority'])

        # Adding model 'ActionEscalation'
        db.create_table(u'incidents_nsir_actionescalation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'incidents_nsir', ['ActionEscalation'])

        # Adding model 'ActionType'
        db.create_table(u'incidents_nsir_actiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'incidents_nsir', ['ActionType'])

        # Adding model 'Investigation'
        db.create_table(u'incidents_nsir_investigation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('incident', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['incidents_nsir.Incident'], unique=True)),
            ('investigator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='investigations', null=True, to=orm['accounts.ILSUser'])),
            ('assigned', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('assigned_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='incidents_assigned', null=True, to=orm['accounts.ILSUser'])),
            ('complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('completed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'incidents_nsir', ['Investigation'])

        # Adding field 'Incident.patient_id'
        db.add_column(u'incidents_nsir_incident', 'patient_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.submitted'
        db.add_column(u'incidents_nsir_incident', 'submitted',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.submitted_by'
        db.add_column(u'incidents_nsir_incident', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ILSUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.valid'
        db.add_column(u'incidents_nsir_incident', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Incident.duplicate'
        db.add_column(u'incidents_nsir_incident', 'duplicate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Incident.duplicate_of'
        db.add_column(u'incidents_nsir_incident', 'duplicate_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.Incident'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.flag'
        db.add_column(u'incidents_nsir_incident', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SharingAudience'
        db.delete_table(u'incidents_nsir_sharingaudience')

        # Deleting model 'IncidentAction'
        db.delete_table(u'incidents_nsir_incidentaction')

        # Deleting model 'IncidentSharing'
        db.delete_table(u'incidents_nsir_incidentsharing')

        # Deleting model 'ActionPriority'
        db.delete_table(u'incidents_nsir_actionpriority')

        # Deleting model 'ActionEscalation'
        db.delete_table(u'incidents_nsir_actionescalation')

        # Deleting model 'ActionType'
        db.delete_table(u'incidents_nsir_actiontype')

        # Deleting model 'Investigation'
        db.delete_table(u'incidents_nsir_investigation')

        # Deleting field 'Incident.patient_id'
        db.delete_column(u'incidents_nsir_incident', 'patient_id')

        # Deleting field 'Incident.submitted'
        db.delete_column(u'incidents_nsir_incident', 'submitted')

        # Deleting field 'Incident.submitted_by'
        db.delete_column(u'incidents_nsir_incident', 'submitted_by_id')

        # Deleting field 'Incident.valid'
        db.delete_column(u'incidents_nsir_incident', 'valid')

        # Deleting field 'Incident.duplicate'
        db.delete_column(u'incidents_nsir_incident', 'duplicate')

        # Deleting field 'Incident.duplicate_of'
        db.delete_column(u'incidents_nsir_incident', 'duplicate_of_id')

        # Deleting field 'Incident.flag'
        db.delete_column(u'incidents_nsir_incident', 'flag')

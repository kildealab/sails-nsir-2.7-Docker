...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'IncidentAction.complete'
        db.delete_column(u'incidents_nsir_incidentaction', 'complete')

        # Deleting field 'IncidentAction.assigned_by'
        db.delete_column(u'incidents_nsir_incidentaction', 'assigned_by_id')

        # Deleting field 'IncidentAction.completed'
        db.delete_column(u'incidents_nsir_incidentaction', 'completed')

        # Deleting field 'IncidentAction.assigned'
        db.delete_column(u'incidents_nsir_incidentaction', 'assigned')

        # Deleting field 'IncidentAction.escalation'
        db.delete_column(u'incidents_nsir_incidentaction', 'escalation_id')

        # Deleting field 'IncidentAction.description'
        db.delete_column(u'incidents_nsir_incidentaction', 'description')

        # Deleting field 'IncidentAction.responsible'
        db.delete_column(u'incidents_nsir_incidentaction', 'responsible_id')

        # Deleting field 'IncidentAction.priority'
        db.delete_column(u'incidents_nsir_incidentaction', 'priority_id')

        # Deleting field 'IncidentAction.action_type'
        db.delete_column(u'incidents_nsir_incidentaction', 'action_type_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'IncidentAction.complete'
        db.add_column(u'incidents_nsir_incidentaction', 'complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'IncidentAction.assigned_by'
        db.add_column(u'incidents_nsir_incidentaction', 'assigned_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='incidentactions_assigned', to=orm['accounts.ILSUser']),
                      keep_default=False)

        # Adding field 'IncidentAction.completed'
        db.add_column(u'incidents_nsir_incidentaction', 'completed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'IncidentAction.assigned'
        db.add_column(u'incidents_nsir_incidentaction', 'assigned',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default='', blank=True),
                      keep_default=False)

        # Adding field 'IncidentAction.escalation'
        db.add_column(u'incidents_nsir_incidentaction', 'escalation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ActionEscalation'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'IncidentAction.description'
        db.add_column(u'incidents_nsir_incidentaction', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'IncidentAction.responsible'
        db.add_column(u'incidents_nsir_incidentaction', 'responsible',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='incidentactions', to=orm['accounts.ILSUser']),
                      keep_default=False)

        # Adding field 'IncidentAction.priority'
        db.add_column(u'incidents_nsir_incidentaction', 'priority',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ActionPriority'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'IncidentAction.action_type'
        db.add_column(u'incidents_nsir_incidentaction', 'action_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['incidents_nsir.ActionType']),
                      keep_default=False)

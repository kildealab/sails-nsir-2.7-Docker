...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Month'
        db.create_table(u'incidents_nsir_month', (
        ...
        db.send_create_signal(u'incidents_nsir', ['Month'])


        # Renaming column for 'Incident.patient_month_birth' to match new field type.
        db.rename_column(u'incidents_nsir_incident', 'patient_month_birth', 'patient_month_birth_id')
        # Changing field 'Incident.patient_month_birth'
        db.alter_column(u'incidents_nsir_incident', 'patient_month_birth_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.Month'], null=True))
        # Adding index on 'Incident', fields ['patient_month_birth']
        db.create_index(u'incidents_nsir_incident', ['patient_month_birth_id'])


    def backwards(self, orm):
        # Removing index on 'Incident', fields ['patient_month_birth']
        db.delete_index(u'incidents_nsir_incident', ['patient_month_birth_id'])

        # Deleting model 'Month'
        db.delete_table(u'incidents_nsir_month')


        # Renaming column for 'Incident.patient_month_birth' to match new field type.
        db.rename_column(u'incidents_nsir_incident', 'patient_month_birth_id', 'patient_month_birth')
        # Changing field 'Incident.patient_month_birth'
        db.alter_column(u'incidents_nsir_incident', 'patient_month_birth', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

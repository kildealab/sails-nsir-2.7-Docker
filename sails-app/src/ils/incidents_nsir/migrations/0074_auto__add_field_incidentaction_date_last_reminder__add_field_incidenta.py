...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IncidentAction.date_last_reminder'
        db.add_column(u'incidents_nsir_incidentaction', 'date_last_reminder',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'IncidentAction.first_reminder_sent'
        db.add_column(u'incidents_nsir_incidentaction', 'first_reminder_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IncidentAction.date_last_reminder'
        db.delete_column(u'incidents_nsir_incidentaction', 'date_last_reminder')

        # Deleting field 'IncidentAction.first_reminder_sent'
        db.delete_column(u'incidents_nsir_incidentaction', 'first_reminder_sent')

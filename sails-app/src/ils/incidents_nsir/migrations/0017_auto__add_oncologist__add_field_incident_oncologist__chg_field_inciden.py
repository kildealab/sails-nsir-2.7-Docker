...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Oncologist'
        db.create_table(u'incidents_nsir_oncologist', (
        ...
        db.send_create_signal(u'incidents_nsir', ['Oncologist'])

        # Adding field 'Incident.oncologist'
        db.add_column(u'incidents_nsir_incident', 'oncologist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.Oncologist'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Incident.descriptor'
        db.alter_column(u'incidents_nsir_incident', 'descriptor', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True))

    def backwards(self, orm):
        # Deleting model 'Oncologist'
        db.delete_table(u'incidents_nsir_oncologist')

        # Deleting field 'Incident.oncologist'
        db.delete_column(u'incidents_nsir_incident', 'oncologist_id')


        # Changing field 'Incident.descriptor'
        db.alter_column(u'incidents_nsir_incident', 'descriptor', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.invalid_reason'
        db.add_column(u'incidents_nsir_incident', 'invalid_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.invalid_reason'
        db.delete_column(u'incidents_nsir_incident', 'invalid_reason')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PredefinedIncident'
        db.create_table(u'incidents_nsir_predefinedincident', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'incidents_nsir', ['PredefinedIncident'])

        # Adding model 'PredefinedField'
        db.create_table(u'incidents_nsir_predefinedfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_field', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('field_value', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('incident_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.PredefinedIncident'])),
        ))
        db.send_create_signal(u'incidents_nsir', ['PredefinedField'])


    def backwards(self, orm):
        # Deleting model 'PredefinedIncident'
        db.delete_table(u'incidents_nsir_predefinedincident')

        # Deleting model 'PredefinedField'
        db.delete_table(u'incidents_nsir_predefinedfield')

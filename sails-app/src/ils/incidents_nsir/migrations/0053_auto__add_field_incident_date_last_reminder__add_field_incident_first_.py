...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.date_last_reminder'
        db.add_column(u'incidents_nsir_incident', 'date_last_reminder',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.first_reminder_sent'
        db.add_column(u'incidents_nsir_incident', 'first_reminder_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.date_last_reminder'
        db.delete_column(u'incidents_nsir_incident', 'date_last_reminder')

        # Deleting field 'Incident.first_reminder_sent'
        db.delete_column(u'incidents_nsir_incident', 'first_reminder_sent')

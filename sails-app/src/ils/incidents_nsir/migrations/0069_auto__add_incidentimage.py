...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IncidentImage'
        db.create_table(u'incidents_nsir_incidentimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('incident', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.Incident'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('uploaded_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_uploaded_image', to=orm['accounts.ILSUser'])),
            ('uploaded_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'incidents_nsir', ['IncidentImage'])


    def backwards(self, orm):
        # Deleting model 'IncidentImage'
        db.delete_table(u'incidents_nsir_incidentimage')
    ...
    models = {
        ...
        u'incidents_nsir.incidentimage': {
            'Meta': {'object_name': 'IncidentImage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

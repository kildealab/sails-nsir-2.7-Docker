...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field radiation_treatment_techniques on 'Incident'
        m2m_table_name = db.shorten_name(u'incidents_nsir_incident_radiation_treatment_techniques')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('incident', models.ForeignKey(orm[u'incidents_nsir.incident'], null=False)),
            ('radiationtreatmenttechnique', models.ForeignKey(orm[u'incidents_nsir.radiationtreatmenttechnique'], null=False))
        ))
        db.create_unique(m2m_table_name, ['incident_id', 'radiationtreatmenttechnique_id'])


    def backwards(self, orm):
        # Removing M2M table for field radiation_treatment_techniques on 'Incident'
        db.delete_table(db.shorten_name(u'incidents_nsir_incident_radiation_treatment_techniques'))
    ...
    models = {
        ...
        u'incidents_nsir.incident': {
            ...
            'coordinator_comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'local_severity_level': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['incidents_nsir.LocalSeverityLevel']", 'null': 'True', 'blank': 'True'}),
            'narrative_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'narrative_by'", 'null': 'True', 'to': u"orm['accounts.ILSUser']"}),
            ...
            'number_patients_involved': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'patient_disclosure': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'radiation_treatment_technique': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'rad_technique'", 'null': 'True', 'to': u"orm['incidents_nsir.RadiationTreatmentTechnique']"}),
            'radiation_treatment_techniques': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'rad_techniques'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['incidents_nsir.RadiationTreatmentTechnique']"}),
        ...
        u'incidents_nsir.incidentaction': {
            ...
            'date_last_reminder': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'description_performed': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
        ...
        u'incidents_nsir.incidentimage': {
            'Meta': {'ordering': "['image_name', 'uploaded_date']", 'object_name': 'IncidentImage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'image_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'incident': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['incidents_nsir.Incident']"}),
            'uploaded_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_uploaded_image'", 'to': u"orm['accounts.ILSUser']"}),
            'uploaded_date': ('django.db.models.fields.DateTimeField', [], {})
        },
        ...
        u'incidents_nsir.localseveritylevel': {
            'Meta': {'ordering': "['order', 'name']", 'object_name': 'LocalSeverityLevel'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {}),

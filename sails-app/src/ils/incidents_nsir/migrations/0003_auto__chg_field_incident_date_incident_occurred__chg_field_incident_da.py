...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incident.date_incident_occurred'
        db.alter_column(u'incidents_nsir_incident', 'date_incident_occurred', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Incident.date_incident_detected'
        db.alter_column(u'incidents_nsir_incident', 'date_incident_detected', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Incident.date_incident_occurred'
        db.alter_column(u'incidents_nsir_incident', 'date_incident_occurred', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

        # Changing field 'Incident.date_incident_detected'
        db.alter_column(u'incidents_nsir_incident', 'date_incident_detected', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

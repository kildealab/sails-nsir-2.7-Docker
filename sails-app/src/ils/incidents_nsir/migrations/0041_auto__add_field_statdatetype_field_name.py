...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatDateType.field_name'
        db.add_column(u'incidents_nsir_statdatetype', 'field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatDateType.field_name'
        db.delete_column(u'incidents_nsir_statdatetype', 'field_name')

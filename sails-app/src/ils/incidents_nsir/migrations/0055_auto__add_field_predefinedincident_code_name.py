...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredefinedIncident.code_name'
        db.add_column(u'incidents_nsir_predefinedincident', 'code_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredefinedIncident.code_name'
        db.delete_column(u'incidents_nsir_predefinedincident', 'code_name')

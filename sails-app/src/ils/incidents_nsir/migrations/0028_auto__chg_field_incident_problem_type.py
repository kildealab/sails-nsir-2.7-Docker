...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incident.problem_type'
        db.alter_column(u'incidents_nsir_incident', 'problem_type_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['incidents_nsir.ProblemType'], null=True))

    def backwards(self, orm):

        # Changing field 'Incident.problem_type'
        db.alter_column(u'incidents_nsir_incident', 'problem_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ProblemType'], null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incident.reportable_circumstance'
        db.alter_column(u'incidents_nsir_incident', 'reportable_circumstance', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Incident.near_miss'
        db.alter_column(u'incidents_nsir_incident', 'near_miss', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Incident.reportable_circumstance'
        db.alter_column(u'incidents_nsir_incident', 'reportable_circumstance', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Incident.near_miss'
        db.alter_column(u'incidents_nsir_incident', 'near_miss', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'incidents_nsir.incident': {
            ...
            'near_miss': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'reportable_circumstance': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

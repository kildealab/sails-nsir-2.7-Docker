...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.investigation_assigned_date'
        db.add_column(u'incidents_nsir_incident', 'investigation_assigned_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.investigation_assigned_by'
        db.add_column(u'incidents_nsir_incident', 'investigation_assigned_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ILSUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.investigation_complete'
        db.add_column(u'incidents_nsir_incident', 'investigation_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Incident.investigation_completed_date'
        db.add_column(u'incidents_nsir_incident', 'investigation_completed_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.investigation_assigned_date'
        db.delete_column(u'incidents_nsir_incident', 'investigation_assigned_date')

        # Deleting field 'Incident.investigation_assigned_by'
        db.delete_column(u'incidents_nsir_incident', 'investigation_assigned_by_id')

        # Deleting field 'Incident.investigation_complete'
        db.delete_column(u'incidents_nsir_incident', 'investigation_complete')

        # Deleting field 'Incident.investigation_completed_date'
        db.delete_column(u'incidents_nsir_incident', 'investigation_completed_date')

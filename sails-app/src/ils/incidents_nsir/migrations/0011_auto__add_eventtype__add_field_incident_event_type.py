...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'incidents_nsir_eventtype', (
        ...
        db.send_create_signal(u'incidents_nsir', ['EventType'])

        # Adding field 'Incident.event_type'
        db.add_column(u'incidents_nsir_incident', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.EventType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventType'
        db.delete_table(u'incidents_nsir_eventtype')

        # Deleting field 'Incident.event_type'
        db.delete_column(u'incidents_nsir_incident', 'event_type_id')

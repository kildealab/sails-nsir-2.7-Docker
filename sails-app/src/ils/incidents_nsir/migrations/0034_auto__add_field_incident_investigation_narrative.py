...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.investigation_narrative'
        db.add_column(u'incidents_nsir_incident', 'investigation_narrative',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.investigation_narrative'
        db.delete_column(u'incidents_nsir_incident', 'investigation_narrative')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.patient_disclosure'
        db.add_column(u'incidents_nsir_incident', 'patient_disclosure',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.patient_disclosure'
        db.delete_column(u'incidents_nsir_incident', 'patient_disclosure')

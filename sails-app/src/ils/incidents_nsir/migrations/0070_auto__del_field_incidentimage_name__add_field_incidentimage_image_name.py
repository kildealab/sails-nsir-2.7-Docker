...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IncidentImage.name'
        db.delete_column(u'incidents_nsir_incidentimage', 'name')

        # Adding field 'IncidentImage.image_name'
        db.add_column(u'incidents_nsir_incidentimage', 'image_name',
                      self.gf('django.db.models.fields.CharField')(default='temp_name', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'IncidentImage.name'
        db.add_column(u'incidents_nsir_incidentimage', 'name',
                      self.gf('django.db.models.fields.CharField')(default='temp', max_length=255),
                      keep_default=False)

        # Deleting field 'IncidentImage.image_name'
        db.delete_column(u'incidents_nsir_incidentimage', 'image_name')

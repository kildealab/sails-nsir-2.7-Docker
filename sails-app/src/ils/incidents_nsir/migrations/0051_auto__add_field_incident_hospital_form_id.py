...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.hospital_form_id'
        db.add_column(u'incidents_nsir_incident', 'hospital_form_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.hospital_form_id'
        db.delete_column(u'incidents_nsir_incident', 'hospital_form_id')

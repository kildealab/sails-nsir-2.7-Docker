...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatParameterType'
        db.create_table(u'incidents_nsir_statparametertype', (
            ...
            ('type_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'incidents_nsir', ['StatParameterType'])


    def backwards(self, orm):
        # Deleting model 'StatParameterType'
        db.delete_table(u'incidents_nsir_statparametertype')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.reported_by'
        db.add_column(u'incidents_nsir_incident', 'reported_by',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Incident.reported_to'
        db.add_column(u'incidents_nsir_incident', 'reported_to',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.reported_by'
        db.delete_column(u'incidents_nsir_incident', 'reported_by')

        # Deleting field 'Incident.reported_to'
        db.delete_column(u'incidents_nsir_incident', 'reported_to')

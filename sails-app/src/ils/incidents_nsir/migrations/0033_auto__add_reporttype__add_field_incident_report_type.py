...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'incidents_nsir_reporttype', (
        ...
        db.send_create_signal(u'incidents_nsir', ['ReportType'])

        # Adding field 'Incident.report_type'
        db.add_column(u'incidents_nsir_incident', 'report_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['incidents_nsir.ReportType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ReportType'
        db.delete_table(u'incidents_nsir_reporttype')

        # Deleting field 'Incident.report_type'
        db.delete_column(u'incidents_nsir_incident', 'report_type_id')

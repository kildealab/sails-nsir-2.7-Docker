...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredefinedIncident.description'
        db.add_column(u'incidents_nsir_predefinedincident', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredefinedIncident.description'
        db.delete_column(u'incidents_nsir_predefinedincident', 'description')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatDateType'
        db.create_table(u'incidents_nsir_statdatetype', (
        ...
        db.send_create_signal(u'incidents_nsir', ['StatDateType'])


    def backwards(self, orm):
        # Deleting model 'StatDateType'
        db.delete_table(u'incidents_nsir_statdatetype')
